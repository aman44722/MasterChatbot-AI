        ...
        >
          ...
          >
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', marginBottom: '10px' }}>
                <img src={avatar} alt="bot" style={{ width: '20px', height: '20px', marginRight: '10px', borderRadius: '50%' }} />
                <div style={{ background: themeColors.question, color: textColorQuestion, padding: '8px 12px', borderRadius: '10px', fontSize: '13px' }}>Sample options will look like this</div>
              </div>
